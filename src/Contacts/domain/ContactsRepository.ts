...
export class ContactsRepository {
  ...
  private toRow(contact: ContactRegistration): Record<string, unknown> {
    return {
      ...
      country_other: contact.countryOther,
      preferred_language: contact.preferredLanguage,
      preferred_language_other: contact.preferredLanguageOther,
      ...
      used_platforms_other: contact.usedPlatformsOther,
      preferred_platform: contact.preferredPlatform,
      preferred_platform_other: contact.preferredPlatformOther,
